...
<details>
  ...
  <p>
  Sistema fullstack para gestão de agendamentos em petshops e clínicas veterinárias.
  </p>
...
<details>
  ...
  <p>
  Plataforma de aluguel que incentiva o consumo compartilhado, permitindo que usuários aluguem objetos e também disponibilizem seus próprios itens.
  </p>

  <p>📌 Projeto em fase de protótipo – não implementado.</p>

  🎨 [Protótipo no Figma](https://www.figma.com/proto/bJe7sXIWnUYPeiFgEikXw3/Novo-Luguel?node-id=1-2&starting-point-node-id=1%3A2)

  <p><strong>Objetivos principais:</strong></p>

  <ul>
    <li>Promover o consumo consciente e sustentável</li>
    <li>Permitir o aluguel de itens do dia a dia</li>
    <li>Facilitar o processo de aluguel e compartilhamento</li>
  </ul>
...
<p>
  ...
  <a href="https://www.linkedin.com/in/camillarodriguesfp/" target="_blank">
